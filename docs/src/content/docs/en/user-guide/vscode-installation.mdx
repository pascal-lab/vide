...
<ThinLinkCard
  href="https://marketplace.visualstudio.com/items?itemName=pascal-lab.vide-code-extension"
  title="Visual Studio Marketplace"
  action="Open"
>
  Install stable Vide, extension ID: <code>pascal-lab.vide-code-extension</code>
</ThinLinkCard>

You can also search for the display name `Vide` or the extension ID `pascal-lab.vide-code-extension` in the VS Code Extensions view.
