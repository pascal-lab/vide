...
**在线体验、安装说明和功能讲解请访问 [用户手册](https://vide.pascal-lab.net/user-guide/)。**
...
Vide 的格式化功能可调用 [Verible](https://github.com/chipsalliance/verible) 的 `verible-verilog-format`；Verible 使用 Apache License 2.0。
