...
pub(crate) fn router() -> LspRouter {
    ...
    requests!(router;
        ...
        HoverRequest => RequestPolicy::LATENCY_SENSITIVE, request::handle_hover;
        GotoDefinition => RequestPolicy::LATENCY_SENSITIVE, request::handle_goto_definition;
        GotoDeclaration => RequestPolicy::LATENCY_SENSITIVE, request::handle_goto_declaration;
        GotoTypeDefinition => RequestPolicy::LATENCY_SENSITIVE, request::handle_goto_type_definition;
        ...
        References => RequestPolicy::LATENCY_SENSITIVE, request::handle_references;
