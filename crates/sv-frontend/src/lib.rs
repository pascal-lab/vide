...
pub mod diagnostics {
    use frontend_api::{FrontendDiagnostic, ParseOptions};
    use syntax::SyntaxTree;
    ...
    pub fn parse_syntax_with_diagnostics(
        ...
        let parsed = slang_adapter::parse_syntax_with_diagnostics(
            text,
            name,
            path,
            options,
    ...
    pub fn parse_library_map_syntax_with_diagnostics(
        ...
        let parsed = slang_adapter::parse_library_map_syntax_with_diagnostics(
            text,
            name,
            path,
            warning_options,
...
pub mod assist {
    use frontend_api::{LexedTokenAtOffset, ParseOptions, ParserExpectedSyntax};
...
pub mod semantic {
    use frontend_api::{FrontendDiagnostic, ParseBufferIds, ParseOptions};
