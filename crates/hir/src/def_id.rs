...
impl DefId {
    ...
    pub fn as_module(self, db: &dyn HirDb) -> Option<crate::hir_def::module::ModuleId> {
        self.primary_origin(db).as_module(db)
    }

    pub fn as_block(self, db: &dyn HirDb) -> Option<crate::hir_def::block::BlockId> {
        self.primary_origin(db).as_block(db)
    }

    pub fn as_generate_block(
        self,
        db: &dyn HirDb,
    ) -> Option<crate::hir_def::module::generate::GenerateBlockId> {
        self.primary_origin(db).as_generate_block(db)
    }

    pub fn as_subroutine(
        self,
        db: &dyn HirDb,
    ) -> Option<InContainer<crate::hir_def::subroutine::LocalSubroutineId>> {
        self.primary_origin(db).as_subroutine(db)
    }

    pub fn as_subroutine_port(
        self,
        db: &dyn HirDb,
    ) -> Option<InSubroutine<crate::hir_def::subroutine::SubroutinePortId>> {
        self.primary_origin(db).as_subroutine_port(db)
    }

    pub fn as_decl(
        self,
        db: &dyn HirDb,
    ) -> Option<InContainer<crate::hir_def::expr::declarator::DeclId>> {
        self.primary_origin(db).as_decl(db)
    }

    pub fn as_typedef(
        self,
        db: &dyn HirDb,
    ) -> Option<InContainer<crate::hir_def::typedef::TypedefId>> {
        self.primary_origin(db).as_typedef(db)
    }

    pub fn as_instance(
        self,
        db: &dyn HirDb,
    ) -> Option<InModule<crate::hir_def::module::instantiation::InstanceId>> {
        self.primary_origin(db).as_instance(db)
    }

    pub fn as_modport(
        self,
        db: &dyn HirDb,
    ) -> Option<InModule<crate::hir_def::module::modport::ModportId>> {
        self.primary_origin(db).as_modport(db)
    }

    pub fn as_clocking_block(
        self,
        db: &dyn HirDb,
    ) -> Option<InModule<crate::hir_def::module::clocking::ClockingBlockId>> {
        self.primary_origin(db).as_clocking_block(db)
    }

    pub fn as_checker(
        self,
        db: &dyn HirDb,
    ) -> Option<InContainer<crate::hir_def::checker::CheckerId>> {
        self.primary_origin(db).as_checker(db)
    }

    pub fn as_covergroup(
        self,
        db: &dyn HirDb,
    ) -> Option<InContainer<crate::hir_def::covergroup::CovergroupId>> {
        self.primary_origin(db).as_covergroup(db)
    }
}
